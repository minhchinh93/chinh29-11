                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__left">
                            <ul>
                                <li><i class="fa fa-envelope"></i> {{$data == false ? 'email':$data->email }}</li>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__right">
                            ...
                            <div class="header__top__right__auth">
                                <a href="{{ $data == false ? route('auth.login') :route('auth.logout') }}"><i class="fa fa-user"></i> {{ $data == true ? 'logout' :'login' }}</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-3">
                <div class="hero__categories">
                    ...
                    <ul>
                        ...
                        <li><a href="#">{{ strtoupper($menu->category_name )}}</a></li>
                        @endforeach
                    </ul>
                </div>
            </div>
